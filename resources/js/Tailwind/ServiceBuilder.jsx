...
const ServiceBuilder = ({ service, generals, systems, fonts, colors, serviceCategories = [] }) => {
    console.log('ServiceBuilder loaded', { service, generals, systems, fonts, colors, serviceCategories });
